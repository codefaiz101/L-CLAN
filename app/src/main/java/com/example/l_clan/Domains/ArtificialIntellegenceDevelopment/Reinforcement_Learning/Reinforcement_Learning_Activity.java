...
import com.example.l_clan.bottomnavigation.Artificial_Intelligence_Bottom_NavigationActivity.ML_Libraries_BottomNavigationActivity.RL_OpenAi_BottomNavigationActivity;
...
public class Reinforcement_Learning_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reinforcement_learning);

        recyclerView1 = findViewById(R.id.RL_Libraries_Recycler);
        ArrayList<ML_Libraries_Model> list1 = new ArrayList<>();
        list1.add(new ML_Libraries_Model("OpenAI Gym", R.drawable.openai_gym));
        ...
        LinearLayoutManager layoutManager1 = new LinearLayoutManager(Reinforcement_Learning_Activity.this, LinearLayoutManager.HORIZONTAL, false);
        ...
        recyclerView1.addOnItemTouchListener(new RecyclerItemClickListener(this, recyclerView1, new RecyclerItemClickListener.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                switch (position) {
                    case 0:
                        Intent intent = new Intent(getApplicationContext(), RL_OpenAi_BottomNavigationActivity.class);
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        Intent intent3 = new Intent(getApplicationContext(), Ml_Keras_BottomNavigationActivity.class);
