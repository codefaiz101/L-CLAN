...
public class AndroidDevelopmentActivity extends AppCompatActivity {

    private ActivityAndroidDevelopmentBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);

        binding = ActivityAndroidDevelopmentBinding.inflate(getLayoutInflater());
...
//    public static class DomainsPartActivity extends AppCompatActivity {
...
//            list.add(new DomainModels("WEB APPLICATIOIN DEVELOPMENT", R.drawable.webdevelopment));
