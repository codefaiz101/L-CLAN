package com.example.l_clan.Domains.ArtificialIntellegenceDevelopment.Deep_Learning;
...
public class Deep_Learning_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView1 = findViewById(R.id.DL_Libraries_Recycler);
        ...
        LinearLayoutManager layoutManager1 = new LinearLayoutManager(Deep_Learning_Activity.this, LinearLayoutManager.HORIZONTAL, false);
            ...
            public void onItemClick(View view, int position) {
                switch (position) {
                    case 0:
                        ...
                        break;
                    case 1:
                        Intent intent1 = new Intent(getApplicationContext(), NN_Pytorch_BottomNavigationActivity.class);
