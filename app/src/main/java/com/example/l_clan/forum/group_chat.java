...
//        binding = ActivityForum1Binding.inflate(getLayoutInflater());     //to replace find view by id
        setContentView(R.layout.activity_group_chat);        //to replace find view by id
        ...
        sendButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!messageText.isEmpty()) {
                    DatabaseReference newMessageRef = mDatabase.child("group").push();
                    ...
                    Toast.makeText(group_chat.this, "Please enter a message", Toast.LENGTH_SHORT).show();
                }
            }
        });
