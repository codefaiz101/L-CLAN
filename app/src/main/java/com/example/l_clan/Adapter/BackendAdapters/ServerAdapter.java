...
public class ServerAdapter extends  RecyclerView.Adapter<ServerAdapter.viewHolder> {
    ArrayList<ServerModels> list;
    Context context;

    public ServerAdapter(ArrayList<ServerModels> list, Context context) {
        this.list = list;
    ...
    public viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.serversinglerecyclerlayout,parent,false);
        return new viewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull viewHolder holder, int position) {
        ServerModels models = list.get(position);
    ...
    public class viewHolder  extends RecyclerView.ViewHolder{
        ...
        public viewHolder(@NonNull View itemView) {
            ...
            textView = itemView.findViewById(R.id.ServerText);
        }
    }
}
